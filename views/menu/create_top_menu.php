          ...
          <div class="row mt-3">
            <div class="col-12 col-lg-12 col-xl-12">
              <div class="card card-fluid">
                <div class="col-12 col-lg-12 col-xl-12"><h4 class="card-header mt-2"> Top Menu </h4><a href="#" class="btn btn-success mt-2 mr-2" style="float: right;" data-toggle="modal" data-target="#topMenu">Create New</a></div>
                <div class="card-body">
                  <table class="table datatable table-hover">
                    ...
                    <?php
                      ...
                      foreach($data as $menu){
                        $button = '<a href="#" data-toggle="modal" data-target="#EdittopMenu'.$menu['top_menu_id'].'"><i class="fas fa-edit text-warning"></i>';
                        $icon = '<i class="'.$menu['top_menu_icon'].'"></i>';
