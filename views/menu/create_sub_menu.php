          ...
          <div class="row mt-3">
            <div class="col-12 col-lg-12 col-xl-12">
              <div class="card card-fluid">
                <div class="col-12 col-lg-12 col-xl-12"><h4 class="card-header mt-2"> Sub Menu </h4><a href="#" class="btn btn-success mt-2 mr-2" style="float: right;" data-toggle="modal" data-target="#SubMenu">Create New</a></div>
                <div class="card-body">
                  <table class="table datatable table-hover">
                    ...
                    <?php
                      ...
                      foreach($data as $menu){
                        $button = '<a href="#" data-toggle="modal" data-target="#EditMainMenu'.$menu['sub_menu_id'].'"><i class="fas fa-edit text-warning"></i>';
                        $icon = '<i class="'.$menu['sub_menu_icon'].'"></i>';
    ...
    <div class="modal-content">
      ...
      <form action="<?php echo url('sub_menu/save'); ?>" method="post">
        ...
        <div class="modal-body mt-2">
          ...
          <div class="form-group">
            <label for="sub_menu_name"> Sub Menu Name <span class="text-danger">*</span></label>
          ...
          <div class="form-group">
            <label for="sub_menu_rank"> Sub Menu Rank <span class="text-danger">*</span></label>
            <input type="number" class="form-control" id="sub_menu_rank" name="sub_menu_rank" placeholder="1 ... .." required>
          </div>
        </div>
        <div class="modal-footer">
          <button type="reset" class="btn btn-secondary" data-dismiss="modal">Close</button>
