  ...
  <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-xs-12 custm">
    ...
    <ul>
        ...
        <?php if ($_SESSION['user_type'] == 6) {
          ...
          <li><a class="active" href="<?php echo url('production/production_details'); ?>">Modified Receipe</a></li>
                       ...
                       <?php }?>
                        ...
                        <td>
                          ...
                          <a href="#" data-toggle="modal" title="Edit" data-target="#edit_production_<?php echo $head['production_id'];?>"><i class="fa fa-edit text-success"></i>
                            ...
                            <a href="#" data-toggle="modal" title="Delete" data-target="#delete_production_<?php echo $head['production_id'];?>"><i class="fas fa-trash text-danger"></i>
                          </a>
