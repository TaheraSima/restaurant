          ...
          <div class="row mt-3"> -->
            ...
            <div class="col-12 col-lg-12 col-xl-12">
              <div class="card card-fluid">
              	<div class="col-12 col-lg-12 col-xl-12"><!-- <h4 class="card-header mt-2">Company Settings</h4><a href="#" class="btn btn-success mt-2 mr-2" style="float: right;" data-toggle="modal" data-target="#company_settings">Create New</a> -->
                  <div class="service">
                        <ul>
                            <li><a href="" data-toggle="modal" data-target="#company_settings"><img src="../assets/images/create-new.jpg"></a></li>
                            <li><a href=""  data-toggle="modal" data-target="#company_settings">Create New</a> </li>
                        </ul>
                    </div>
                </div>
                <div class="card-body">
