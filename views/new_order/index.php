...
<div class="row">
 <div class="col-md-6">
   ...
   <?php endforeach; ?>
     ...
     <div class="card-body productcollapse" id="Raw" style="padding: 10px !important;">
       <div class="card" style="margin-bottom: 10px !important; box-shadow: none !important;">
          <div class="row">
            ...
            foreach($sqlrawItem as $item) {
                   ...
                   ?>
                    ...
                    >
                     ...
                     <div class="card card-order-page" style="height: 200px !important;">

                       <img src="<?php echo url('assets/products_photo/defaultimg.jpg'); ?>" class="card-img-top" alt="Food Item Photo." style="height: 100px !important;">
                       <div class="card-body">
     ...
     <div class="card-body productcollapse" id="All" style="padding: 10px !important;">
         ...
         <div class="row">
            <?php foreach($data2 as $prdc){
                ...
                ?>
                    ...
                    >
                     <div class="card card-order-page" style="height: 200px !important;">
                       <img src="<?php echo url('assets/products_photo/').$prdc['products_photo']; ?>" class="card-img-top" alt="Food Item Photo." style="height: 100px !important;">
                       <div class="card-body">
   ...
   <?php foreach($data3 as $category){ ?>
     <div class="card-body productcollapse" id="<?php echo 'Category_'.$category['category_id']; ?>" style="padding: 10px !important;">
                 ...
                 if($cat == $products['category_id']){
                   ...
                   ?>
                    <!-- <div class="col-md-4" id="removeLoadEvn<?php echo $pid; ?>" onclick="loadItem(<?php echo '\''.$price.'\', \''.$name.'\',  \''.$dis_prc.'\', \''.$pid.'\''; ?>)"> -->
                     ...
                     <div class="card card-order-page" style="height: 200px !important;">
                       <img src="<?php echo url('assets/products_photo/').$products['products_photo']; ?>" class="card-img-top" alt="Food Item Photo." style="height: 100px !important;">
                       <div class="card-body">
 ...
 <div class="col-md-6">
   <div class="card card-fluid p-2">                    
     <form action="<?php echo url('new_order/save'); ?>" target="_blank" method="post" enctype="multipart/form-data">
     <div class="row">
        <div class="col-md-3">
     ...
     <div class="card-header thead-ligh">
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 row">
           <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 row">
             <select class="custom-text form-control col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 mb-2" id="payment" name="payment_type" style="border: none; background: transparent; margin-left:10px !important;" required>
                 <option value="" class="custom-text">Select Method</option>
                 <option class="custom-text" value="1">Cash</option>
                 <option class="custom-text" value="2">Card</option>
                 <option class="custom-text" value="3">Receivable</option>
             </select>
           ...
           <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 pl-5">
              ...
              <div class="form-row" style="border-bottom: 1px solid #CCC;">
                <label class="col">Commission(%)</label>
                <input type="number" class="custom-text form-control dis_amnt col" style="border: none; background: transparent;" name="dis_amnt" value="<?php echo isset($_GET['id'])?$_GET['dis_amnt']:0; ?>" readonly>
              </div>
              <div class="form-row" style="border-bottom: 1px solid #CCC;">
      ...
      <br>
      <button type="submit" name="" class="custom-text form-control col" style="background-color: #cfe7f3;">
        <b>Charge (<span id="amountTotalbtn">0</span>)</b>
      </button>
      <button type="reset" onClick="window.location.reload();" class="custom-text form-control col btn btn-primary">New Sale</button>
    </form>
   </div>
      ...
      // if (pdata == 'YES') {
        ...
        <td class=" col-checker align-middle serials">\
          <div class="custom-control custom-control-nolabel custom-checkbox" style="margin-left:-5px;">\
           ...
           <input type="hidden" id="products_type_id" name="products_type_id[]" value="2"/>\
            </label>\
  ...
  function loadItemraw(price, name, discount, p_id, item_id){
      ...
      // if (rdata == 'YES') {
        ...
        <td class=" col-checker align-middle serials">\
          <div class="custom-control custom-control-nolabel custom-checkbox" style="margin-left:-5px;">\
           ...
           <input type="hidden" id="products_type_id" name="products_type_id[]" value="1"/>\
            </label>\
            <span style="margin-left:3px;" class="trSerial">'+serials+'</span>\
          </div>\
        </td>\
   ...
   $('.customers_id').click(function(){
    ...
    function final_amount(grand_total=0, pdis_price=0, sp_discount=0, disamnt=0){
      // if (disamnt>0) {
      //   var disamnt = (disamnt*grand_total)/100;
      // }
      // else{
      //   var disamnt = 0;
      // }
      // var disamnt = (disamnt*grand_total)/100;
      var actual_price = Math.round(grand_total-(pdis_price+disamnt+sp_discount));
      $(".actual_price").val(actual_price);
      // $(".actual_price").val(disamount);
      $(".amountTotal").val(actual_price);
      $("#amountTotalbtn").html(actual_price);
    }

    $('.sp_discount').keyup(function(){    
        var sp_discount = parseFloat( $(this).val() );
        var actual_price = parseFloat($('.actual_price').val());
        var totalAmnt = Math.round(actual_price - sp_discount);
        $('.amountTotal').val(totalAmnt); 
        $('#amountTotalbtn').html(totalAmnt); 
    });
