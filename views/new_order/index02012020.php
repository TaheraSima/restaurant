                         ...
                         <table>
                           <tr class="custom-text">
                             <th style="width:250px; padding: 20px; ">
                                 <select class="custom-text form-control" id="payment" name="payment_type" style="border: none; background: transparent;" required>
                             ...
                             <th style="width:160px; margin-left: 10px;"><input type="text" style="border: none; background: transparent;" class="custom-text form-control total" name="total" value="00.00" readonly></th>
                           </tr>
                           <tr class="custom-text">
                             ...
                             <th style="width:160px; margin-left: 10px;"><input type="text" style="border: none; background: transparent;" class="custom-text form-control vat" name="vat" value="00.00" readonly></th>
                           </tr>
                           <tr class="custom-text">
                             ...
                             <th style="width:160px; margin-left: 10px;">
                               <input type="text" style="border: none; background: transparent;" class="custom-text form-control grand_total" name="grand_total" value="00.00" readonly>
                          ...
                          <tr class="custom-text">
                            ...
                            <th style="width:150px"></th>
                             ...
                             <th style="width:160px; margin-left: 10px;"><input type="text" style="border: none; background: transparent;" class="custom-text form-control pdis_price" id="pdis_price" name="pdis_price" value="00.00" readonly></th>
                          </tr> 
                          <tr class="custom-text">
                            <th style="width:250px; padding: 20px; "></th>
                            <th style="width:150px"></th>
                            <th style="width:150px"></th>
                             ...
                             <th style="width:160px; margin-left: 10px;">
                              ...
                              <input type="text" class="custom-text form-control dis_amnt" style="border: none; background: transparent;" name="dis_amnt" value="<?php echo isset($_GET['id'])?$_GET['dis_amnt']:0; ?>" readonly>
                            </th>
                          </tr> 
                          <tr class="custom-text">
                            <th style="width:250px; padding: 20px; "></th>
                            ...
                            <th style="width:150px"></th>
                             ...
                             <th style="width:160px; margin-left: 10px;"><input type="text" style="border: none; background: transparent;" class="custom-text form-control actual_price" id="actual_price" name="actual_price" value="00.00" readonly></th>
                          </tr> 
                          <tr class="custom-text">
                            <th style="width:250px; padding: 20px; "></th>
                            <th style="width:150px"></th>
                            <th style="width:150px"></th>
                             ...
                             <th style="width:160px; margin-left: 10px;"><input type="text" name="sp_discount" value="0.00" class="custom-text form-control sp_discount" style="border: none; background: transparent;" placeholder="-- Enter Discount --" required/></th>
                          </tr> 
                          <tr class="custom-text">
                            <th style="width:250px; padding: 20px; "></th>
                            <th style="width:150px"></th>
                            <th style="width:150px"></th>
                             ...
                             <th style="width:160px; margin-left: 10px;"><input type="text" name="amountTotal" value="0.00" class="custom-text form-control amountTotal" style="border: none; background: transparent;" placeholder="-- Enter Discount --" required/></th>
                          </tr> 
                           <tr class="custom-text">
                             <th style="width:65px"></th>
  ...
  function loadItemraw(price, name, discount, p_id, item_id){
   ...
   $('.customers_id').click(function(){
           ...
           var groupDis = grpid;
            $.ajax({
              ...
              success: function(ret_data){
                ...
                //console.log(grand_total, pdis_price, sp_discount, cus_discount);
    ...
    $( '.f-item' ).click( function( event ) {
      ...
      // $( '.f-item' ).addClass( 'already-added' );
      // $( this ).addClass( 'already-added' );
      // console.log( $( this ).attr( 'id' ) );
      // console.log( $( '[data-f-item-element=' + $( this ).attr( 'id' ) + ']' ) );
