...
<html lang="en">
	<head>
	    ...
	    <link rel="stylesheet" href="<?php echo base_url('site_link'); ?>assetsv/font-awesome/css/all.css">
		<link rel="stylesheet" type="text/css" href="<?php echo base_url('site_link'); ?>assetsv/css/style.css">
