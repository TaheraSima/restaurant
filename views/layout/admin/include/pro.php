<div class="dropdown d-flex">
    ...
    <div class="dropdown-menu">
      ...
      <a class="dropdown-item" href="<?php echo url('dashboard/profile/').md5(rand()).md5($_SESSION['user_id']); ?>"><span class="dropdown-icon oi oi-person"></span> Profile</a>
      <div class="dropdown-divider"></div>
      <a class="dropdown-item" href="<?php echo url('dashboard/changepassword/').md5(rand()).md5($_SESSION['user_id']); ?>"><span class="dropdown-icon oi oi-lock-unlocked"></span> Change Password</a>
