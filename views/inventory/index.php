          ...
          <div class="row mt-3">
            <div class="col-12 col-lg-12 col-xl-12">
              <div class="card card-fluid">
                <div class="col-12 col-lg-12 col-xl-12"><h4 class="card-header mt-2">New Purchase <span class="text-danger"></span></h4>
                  
                   <a href="#" class="btn btn-success mt-2 mr-2" style="float: right;" data-toggle="modal" data-target="#new_purchase">Create New</a>
        ...
        <div class="modal-body">
          <div class="row"><br></div>
            <div class="row row-no-gutters border pt-2 pb-2 bg-info text-white mb-2">
                ...
                <div class="col-sm-1 border-left">Req. Qty</div>
            ...
            <div class="row row-no-gutters border">
              ...
              <div class="col-sm-3"><?php echo $dt['item_name'];?></div>
              <div class="col-sm-1"><?php echo $dt['new_purchase_quantity'];?></div>
              <div class="col-sm-2"><?php echo $dt['new_purchase_unit_price'];?></div>
              <div class="col-sm-2"><input type="text" class="form-control" name="approved_qty" value="<?php echo $dt['new_purchase_quantity'] ;?>"></div>
              <div class="col-sm-3">
      ...
      <form action="<?php echo url('new_purchase/save'); ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="modal-body mt-2">
          <div class="form-group"> 
                <label for="req_no">Entry No<span class="text-danger"></span></label>
          ...
          <div class="col-md-4">
              <button type="button" class="btn btn-success item-add">+ More Entry</button>
          </div><br>
