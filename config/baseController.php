          ...
          <div class="row mt-3">
            <div class="col-12 col-lg-12 col-xl-12">
              <div class="card card-fluid">
              	<div class="col-12 col-lg-12 col-xl-12"><h4 class="card-header mt-2">'.$view_folder.' <span class="text-danger">Please Change This Title !</span></h4><a href="#" class="btn btn-success mt-2 mr-2" style="float: right;" data-toggle="modal" data-target="#'.$view_folder.'">Create New</a></div>
                <div class="card-body">
      ...
      <form action="<?php echo url(\''.$view_folder.'/save\'); ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="modal-body mt-2">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="'.$view_folder.'_name" name="'.$view_folder.'_name" placeholder="..........." required>
          </div>
        </div>
        <div class="modal-footer">
          <button type="reset" class="btn btn-secondary" data-dismiss="modal">Close</button>
